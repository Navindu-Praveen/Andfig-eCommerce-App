...
import com.example.andfig.adapters.SliderAdapter;
...
public class OnBoardingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addDots(0);
        viewPager.addOnPageChangeListener(cahangeListner);
    ...
    ViewPager.OnPageChangeListener cahangeListner =new ViewPager.OnPageChangeListener() {
        @Override
